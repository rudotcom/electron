    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price_net', models.DecimalField(decimal_places=2, default=0, max_digits=9, verbose_name='Сумма товаров')),
                ('total_price_gross', models.DecimalField(decimal_places=2, default=0, max_digits=9, verbose_name='Общая сумма')),
                ('status', models.CharField(choices=[('cart', 'Корзина'), ('new', 'Оформлен'), ('in_progress', 'В обработке'), ('is_ready', 'Готов'), ('shipped', 'Отправлен'), ('delivered', 'Доставлен в место выдачи'), ('received', 'Получен'), ('return', 'Возврат'), ('canceled', 'Отменен')], default='cart', max_length=100, verbose_name='Статус заказа')),
                ...
                ('payment_type', models.CharField(choices=[('cash_card', 'Наличные или банковская карта в мастерской'), ('bankcard', 'Банковская карта онлайн'), ('wallet', 'Kiwi кошелёк / Paypal')], default=None, max_length=100, null=True, verbose_name='Способ оплаты')),
